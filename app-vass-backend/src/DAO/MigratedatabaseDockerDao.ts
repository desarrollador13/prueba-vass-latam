...
export class MigratedatabaseDockerDao {
	...
	constructor(
		...
		this.hostDockerD=`postgresql://postgres:admin@database/vass_latam`
		...
		try{
			...
			arrayIns3=[
				`INSERT INTO public.usuarios("NombreUsuario","ApellidosUsuario","Loguinusuario","Contrasena","IdRoles","IdSede") 
				 VALUES ('admin13','admin13', 'admin13', '$2a$10$WSXrYWpGKbJHioVrIfFjk.0XjBbiwK6Dwjn4OavB9cc2FjyvnHcHa', 2, 1);`
			]

			arrayIns4=[
			 `INSERT INTO public.sede("Nombre", "Direccion", "Telefeno", "IdCiudad") VALUES ('sede calle 26', 'calle 24 31 12', '3764523', 1);`
			]
			...
			resIu5=await pool.query(`INSERT INTO public.usuarios("NombreUsuario", "ApellidosUsuario", "Loguinusuario", "Contrasena", "IdRoles", "IdSede")
															VALUES ('Jonathan','Pinto', 'jonathan', '$2a$10$WSXrYWpGKbJHioVrIfFjk.0XjBbiwK6Dwjn4OavB9cc2FjyvnHcHa', 1, 1);`)
			//$2a$10$IX.Z6dcnnZOHAqcI2eYUbOBlwAPk2kqRiVoaChNjYfstGOb73sRmy
